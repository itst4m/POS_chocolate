	...
	<div class="padding">
		<div class="bgwhite">
			<div class="padding">
				...
				if ($_SESSION['status']==1) {
				?>
				<h3 class="jdl">Detail Laporan Pembelian Chocolate</h3>
				<?php }else{ ?>
				<h3 class="jdl">Detail Transaksi Pembelian Chocolate</h3>
				<?php } ?>
				<?php
				...
				<table>
					<tr>
						<td><span class="label">Nama Pembeli Chocolate</span></td><td><span class="label">:</span></td>
